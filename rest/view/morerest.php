...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta charset="utf-8">
    <title>Отзывы блюда</title>
    <script src="../js/jquery-3.4.0.min.js" charset="utf-8"></script>
    <link rel="stylesheet" href="../css/main.css">
    <link rel="stylesheet" href="../css/morerest.css">
  ...
  <body>
    ...
    <?php require_once '../components/view.morerest.php'; ?>
    ...
    <script src="../js/components.editmorerate.js" charset="utf-8"></script>
    <script src="../js/components.addmorerate.js" charset="utf-8"></script>
</div>
</body>
</html>
